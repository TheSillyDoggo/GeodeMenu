...
AdvLabelStruct AdvLabelBMFont::structFromString(std::string lbl, bool splitSpaces, bool showTags, bool splitChars)
{
    AdvLabelStruct str;
    std::string c = "";
...
{
    setStruct(structFromString(newString, splitEverySpace, showTags, splitChars));
}
