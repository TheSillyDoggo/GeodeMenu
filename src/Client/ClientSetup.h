...
#pragma region Setup Windows
    ...
    static void registerIncompatibilitys()
    {
        ...
        #ifdef GEODE_IS_WINDOWS
        Client::GetModule("tps-bypass")->setIncompatible("This mod has <cr>not yet</c> been ported to <cl>2.206</c> on <cl>Windows</c>.");
        ...
        Client::GetModule("rand-seed")->setIncompatible("This mod has <cr>not yet</c> been ported to <cl>2.206</c> on <cl>Windows</c>.");
        #endif
